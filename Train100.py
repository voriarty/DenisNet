...
def main():
    ...
    text_name1 = '../DCRA/Text/DenseNext/' + args.name + '_train.txt'
    text_name2 = '../DCRA/Text/DenseNext/' + args.name + '_test.txt'
    print(text_name1)
    print(text_name2)
    ...
    # create model
    # model=dnse.DenseSe(args.layers, 100, args.growth, reduction=args.reduce,
    ...
    model = dn.DCRA(args.layers, 100, args.growth, reduction=args.reduce,
                         bottleneck=args.bottleneck, dropRate=args.droprate,
                         SE_model=args.se_model,SE_Residual_model=args.se_re_model,Reducation=args.reducation,num_group=args.group)
